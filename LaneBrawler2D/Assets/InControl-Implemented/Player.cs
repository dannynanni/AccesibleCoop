namespace MultiplayerWithBindingsExample
{
	...
	public class Player : MonoBehaviour
	{
        ...
        private void playIOFunc()
        {
            ...
            if (Actions.XButton.WasPressed)
            {
                AOT.passXButton(true);
            }
            else if (Actions.XButton.WasReleased)
            {
                AOT.passXButton(false);
            }

            if (Actions.BButton.WasPressed)
            {
                AOT.passBButton(true);
            }
            else if (Actions.BButton.WasReleased)
            {
                AOT.passBButton(false);
            }
        }
